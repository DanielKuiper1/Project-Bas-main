...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 15 mei 2024 om 11:37
...
CREATE TABLE `artikel` (
  ...
  `artOmschrijving` varchar(32) NOT NULL,
...
ALTER TABLE `inkooporder`
  ...
  ADD UNIQUE KEY `unique_order` (`levId`,`artId`),
  ADD KEY `artId` (`artId`);
...
ALTER TABLE `verkooporder`
  ...
  ADD UNIQUE KEY `unique_order` (`klantId`,`artId`),
  ADD KEY `artId` (`artId`);
